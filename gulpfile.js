...
let path = {
	build: {
		html: "./", //?указываем путь к HTML
		css: "./css/", //?указываем путь к CSS
		js: "./js/",
		img: "./img/",
		fonts: "./fonts/",
	},
	...
	clean: ["../library/*.html", "../library/css", "../library/fonts", "../library/img", "../library/js"] //?будет удалять папку когда запускается GULP
}
